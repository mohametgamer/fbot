...
setInterval(() => {
  http.get(`http://syscredits.glitch.me/`);
}, 280000);
...
client.on('guildCreate', guild => {
  var embed = new Discord.RichEmbed()
  .setColor(0x5500ff)
  .setDescription(`**__ شكراً لك لإضافه البوت الى سيرفرك __**`)
      guild.owner.send(embed)
});

const devs = ["528496333393494026"]
...
**
『-credits ====> لمعرفة عدد الكريدت الخاصة بك
『-daily ====> للحصول على الكريدت اليومي
...
if(credits[message.author.id].daily != moment().format('L')) {
       ...
       credits[message.author.id].daily = moment().format('L');
          ...
          let ammount = (300, 500, 100, 200, 120, 150, 350, 320,220,1000);
...
client.login('NjQyNzYzMTI5NzYzMTM1NDg5.Xc2ZtQ.b02EZSgUG5X5vQxCbZzuwC51aA8');
